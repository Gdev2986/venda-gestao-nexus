...
const ImmersiveHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-sigma-teal-900 via-sigma-cyan-900 to-sigma-slate-900 overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-sigma-cyan-400 rounded-full animate-float opacity-40"
            style={{
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="text-left order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-in-right" style={{
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-sigma-teal-500 to-sigma-cyan-600 hover:from-sigma-teal-600 hover:to-sigma-cyan-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
              >
                Entre em Contato
          ...
          <div className="flex justify-center items-center order-2">
            <div 
              className="relative w-80 h-48 cursor-pointer transition-all duration-700 hover:scale-105" 
              style={{
                perspective: '1000px',
            ...
            >
              ...
              >
                {/* Card Front */}
                <div 
                  className="absolute inset-0 w-full h-full rounded-2xl bg-gradient-to-br from-sigma-teal-600 via-sigma-cyan-600 to-sigma-teal-700 shadow-2xl border border-white/20" 
                  style={{
                ...
                {/* Card Back */}
                <div 
                  className="absolute inset-0 w-full h-full rounded-2xl bg-gradient-to-br from-sigma-slate-800 to-sigma-slate-900 shadow-2xl border border-white/20" 
                  style={{
                    backfaceVisibility: 'hidden',
