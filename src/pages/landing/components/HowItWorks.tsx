...
const HowItWorks = () => {
  ...
  return <section id="como-funciona" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sigma-slate-50 to-white">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative z-10">
            {steps.map((step, index) => <div key={index} className="relative animate-slide-in-left" style={{
                ...
                <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 sm:hover:-translate-y-4 border-0 shadow-lg bg-white h-full">
                  <CardContent className="p-6 sm:p-8 text-center">
                    ...
                    <div className="relative mb-4 sm:mb-6">
                      ...
                      {index < steps.length - 1 && <div className="hidden lg:block absolute top-1/2 -right-8 xl:-right-12 transform -translate-y-1/2">
