    ...
    <div className="container mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gerencie suas configurações financeiras e chaves PIX.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <Tabs defaultValue="pix" className="w-full">
            ...
            <TabsContent value="preferences">
              <div>
                <h3 className="text-xl font-semibold mb-4">Preferências Financeiras</h3>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <Label htmlFor="report-format">Formato de Relatório Padrão</Label>
                    <Input
                      id="report-format"
                      defaultValue="PDF"
                    />
