...
const AdminSidebar = memo(({ isOpen, isMobile, onClose, userRole }: AdminSidebarProps) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 text-white transition-transform duration-200 ease-in-out",
      ...
      >
        ...
        <div className="p-4 border-t border-sidebar-border">
          ...
          <button
            ...
            className="flex items-center w-full px-3 py-2 text-sm rounded-md text-gray-300 hover:bg-sidebar-accent/70 hover:text-white transition-colors"
          >
